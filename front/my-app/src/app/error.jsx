    ...
    return (
        <main>
            ...
            <div className="flex flex-col items-center gap-6 max-w-md text-center">
                ...
                <Link  href="/home" className="px-8 py-4 mb-10 text-xl font-semibold rounded bg-customColorTertiary text-gray-50 hover:shadow transition-colors">Volver al Home</Link>
            </div>
        </div>
