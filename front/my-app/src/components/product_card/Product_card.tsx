...
function Product_card(producto: any): any {
  return (
    <div className="border-2 border-customColorPrimary w-64 h-72 m-2 rounded-lg flex flex-col justify-center items-center overflow-hidden cursor-pointer transition duration-200 ease-in-out transform hover:shadow-lg hover:bg-customColorPrimary">
      <img
