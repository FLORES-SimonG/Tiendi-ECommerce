        ...
        <div className="flex flex-row row flex-wrap items-center justify-center leading-relaxed  gap-8 m-8  ">
          {orders.map((order) => (
            <div className=" rounded-t-2xl rounded-b-lg  hover:scale-105 transition-all cursor-pointer border-2 shadow-xl" key={order.id}>
              <div className="bg-gradient-to-b from-customColorTertiary from-20% to-customColorSecondary to-90% p-2 rounded-t-2xl">
             ...
             <hr className="border-2" />
              <div className="bg-transparent p-1  rounded-b-xl">
                ...
                <p className="m-3 p-1 rounded-lg hover:scale-105 transition-all bg-slate-200 text-center hover:shadow-xl hover:bg-green-50">{order.status}</p>
